export function EthereumIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_2201_35334)">
        <path
        ...
        />
        <path
          d="M10.3113 12.8582L14.9969 10.1375L10.3113 8.04504V12.8582Z"
          fill="white"
          fillOpacity="0.2"
        />
        <path
          d="M5.625 10.1375L10.3113 12.8582V8.04504L5.625 10.1375Z"
          fill="white"
          fillOpacity="0.602"
        />
      </g>
      <defs>
        <clipPath id="clip0_2201_35334">
