      ...
      <PopoverContent className="w-56" align="end">
        <div className="space-y-4">
          ...
          <nav className="space-y-2">
            <Link
              to="/profile"
              className="flex items-center space-x-2 rounded-lg px-3 py-2 text-sm hover:bg-[var(--accent)]/80 transition-colors"
            >
            ...
            <button
              onClick={toggle}
              className="w-full flex items-center justify-between rounded-lg px-3 py-2 text-sm hover:bg-[var(--accent)]/80 transition-colors"
            >
              <div className="flex items-center space-x-2">
