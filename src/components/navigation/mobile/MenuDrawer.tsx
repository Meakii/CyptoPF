  ...
  return (
    <VaulDrawer.Root open={open} onOpenChange={onOpenChange}>
      <VaulDrawer.Portal>
        ...
        <VaulDrawer.Content className="bg-(--layer-low) flex flex-col rounded-t-[10px] h-[96%] mt-24 fixed bottom-0 left-0 right-0">
          <div className="p-4 bg-(--layer-low)  rounded-t-[10px] flex-1">
